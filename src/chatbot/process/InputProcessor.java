...
public class InputProcessor {
	...
	public String getReply(String userUtterance) {
		...
		if (ChatBot.needJMegaHAL) potentialOutputUtterances.add(new AbstractMap.SimpleEntry<Then, Double>(new Then("JMegaHAL", "random", JMegaHAL.getReply(userUtterance)), RuleProcessor.getUtilValue("random")));
